...
public class TestRunnerClient {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// runner.runCommand("lighthouse --output json --chrome-flags=\"--headless\"
		// --output-path=./lighthouse-results.json http://www.google.com");
		// runner.runCommand("calabash-android resign
		// apk/es.usc.citius.servando.calendula_34.apk");
		// runner.runCommand("calabash-android resign
		// Calendula_v2.5.4_apkpure.com.apk");
		// runner.runCommand("calabash-android run Calendula_v2.5.4_apkpure.com.apk
		// --format json --out calendula.json");
		...
		runner.runCommand(ApplicationConstants.KILL_EMULATOR);
	}
