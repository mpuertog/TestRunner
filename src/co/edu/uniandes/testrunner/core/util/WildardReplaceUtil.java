...
public class WildardReplaceUtil {
     ...
     *
     * @param filePath La URL del archivo Cypress de destino
     * @param url La URL que debe ir dentro del archivo
     */
     ...
     *
     * @param configFilePath La URI del archivo de destino
     * @param screenshotPath La URI que debe ir dentro del archivo
     */
